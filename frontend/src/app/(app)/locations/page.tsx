...
type ShelfNode = { idShelf: number; shelf_code: string; shelf_name: string; current_boxes: number; capacity_boxes: number; occupancy_percent: number; status: string; boxes: BoxNode[] };
