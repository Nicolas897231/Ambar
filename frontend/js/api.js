(function () {
  ...
  const api = {
    ...
    endpoints: {
      ...
      employeeCompliance: (identification) => request(`/hr/employees/${encodeURIComponent(identification)}/compliance`),
      employeeTimeline: (identification) => request(`/hr/employees/${encodeURIComponent(identification)}/timeline`),
      employeeContracts: (identification) => request(`/hr/employees/${encodeURIComponent(identification)}/contracts`),
