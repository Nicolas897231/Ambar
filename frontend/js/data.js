/* ============================================================
   AMBAR - RBAC visual, navegacion y utilidades de presentacion`r`n   Los datos operativos vienen del backend por medio de frontend/js/api.js.
   ============================================================ */

/* ---- CatÃ¡logo de permisos agrupado por mÃ³dulo (para la matriz) ---- */
window.PERM_GROUPS = [
  { mod: "GestiÃ³n Documental", perms: [
    ["document.read", "Ver documentos del Ã¡rea"],
  ...
  { mod: "TRD", perms: [["trd.manage", "Administrar series y retenciÃ³n"]] },
  { mod: "Archivo & Custodia", perms: [
    ["archive.manage", "Administrar archivos y ubicaciones"],
    ["transfer.manage", "Gestionar recepciÃ³n"],
  ...
  { mod: "ExÃ¡menes MÃ©dicos (SST)", perms: [["medical.view", "Consultar exÃ¡menes"], ["medical.manage", "Programar y registrar"]] },
  ...
  { mod: "BÃºsqueda & OCR", perms: [["search.query", "Buscar"], ["ocr.manage", "Operar digitalizaciÃ³n/OCR"]] },
  { mod: "Reportes & BI", perms: [["analytics.view", "Indicadores operativos"], ["bi.view", "Tableros gerenciales"]] },
  { mod: "Seguridad", perms: [["users.manage", "Usuarios, roles y permisos"], ["audit.view", "AuditorÃ­a"]] },
  { mod: "Plataforma", perms: [["platform.view", "ConfiguraciÃ³n"], ["integration.manage", "Integraciones"], ["signature.manage", "Firmas"], ["workflow.manage", "AutomatizaciÃ³n"]] },
...
window.ROLES = {
  ...
  jefe_archivo: { name: "Jefe de Archivo", color: "var(--viz-amber)", area: "Archivo",
    desc: "Define polÃ­ticas documentales, aprueba transferencias y supervisa el archivo.",
  ...
  auxiliar_archivo: { name: "Auxiliar de Archivo", color: "var(--viz-teal)", area: "Archivo",
    desc: "Recibe, clasifica, digitaliza y ubica documentos. Gestiona prÃ©stamos.",
  ...
  gerente_rrhh: { name: "Gerente de RRHH", color: "var(--viz-rose)", area: "RRHH",
    desc: "Administra empleados, contratos, candidatos, vacantes y exÃ¡menes mÃ©dicos.",
  ...
  analista_rrhh: { name: "Analista de RRHH", color: "var(--viz-sky)", area: "RRHH",
    desc: "Registra candidatos, actualiza expedientes y gestiona el pipeline de selecciÃ³n.",
  ...
  sst: { name: "Responsable SST", color: "var(--viz-green)", area: "Seguridad y Salud",
    desc: "Programa y hace seguimiento a exÃ¡menes mÃ©dicos ocupacionales.",
    perms: ["medical.view","medical.manage","hr.view","document.read","search.query","notification.read"] },
  recepcion: { name: "RecepciÃ³n", color: "var(--viz-gold)", area: "RecepciÃ³n",
    desc: "Radica correspondencia entrante y saliente; distribuye a las Ã¡reas.",
    perms: ["mail.view","mail.manage","document.read","document.create","search.query","notification.read"] },
  gerencia: { name: "Gerencia", color: "var(--viz-indigo)", area: "DirecciÃ³n",
    desc: "Consulta tableros ejecutivos e indicadores. No opera mÃ³dulos transaccionales.",
    perms: ["analytics.view","bi.view","document.read_all","hr.view","audit.view","notification.read"] },
  consultor: { name: "Consultor", color: "var(--muted)", area: "Cualquier Ã¡rea",
    desc: "Solo lectura de los documentos de su Ã¡rea.",
...
/* ---- Usuarios: solo backend. Se mantiene arreglo vacio para compatibilidad visual. */
window.USERS = [];
...
/* ---- NavegaciÃ³n (filtrada por permisos en el shell) ---- */
window.NAV = [
  ...
  { label: "GestiÃ³n Documental", icon: "file-text", items: [
    ...
    { key: "digitization", label: "DigitalizaciÃ³n", icon: "scan-line", perms: ["ocr.manage"] },
    { key: "trd", label: "TRD & RetenciÃ³n", icon: "table", perms: ["trd.manage"] },
  ]},
  { label: "Archivo & Custodia", icon: "warehouse", items: [
    { key: "archive", label: "Archivo FÃ­sico", icon: "warehouse", perms: ["archive.manage","document.read"] },
    { key: "transfers", label: "Transferencias", icon: "route", perms: ["transfer.batch_manage","document.transfer"] },
    { key: "loans", label: "PrÃ©stamos", icon: "package-check", perms: ["document.transfer","transfer.manage"] },
  ...
  { label: "Talento Humano", icon: "briefcase", items: [
    ...
    { key: "medical", label: "ExÃ¡menes MÃ©dicos", icon: "stethoscope", perms: ["medical.view","medical.manage"] },
  ...
  { label: "Inteligencia", icon: "bar-chart", items: [
    ...
    { key: "audit", label: "AuditorÃ­a", icon: "shield-check", perms: ["audit.view"] },
  ]},
  { label: "AdministraciÃ³n", icon: "server-cog", items: [
    { key: "security", label: "Seguridad", icon: "shield", perms: ["users.manage"] },
    { key: "settings", label: "ConfiguraciÃ³n", icon: "settings", perms: ["platform.view","integration.manage"] },
  ]},
];
