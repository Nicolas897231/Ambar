...
window.PERM_GROUPS = [
  ...
  { mod: "Radicación", perms: [["mail.view", "Consultar radicados"], ["mail.manage", "Radicar y tramitar"]] },
...
window.ROLES = {
  ...
  recepcion: { name: "Recepción", color: "var(--viz-gold)", area: "Recepción",
    desc: "Radica comunicaciones entrantes y salientes; distribuye a las áreas.",
...
window.NAV = [
  ...
  { label: "Operar custodia", icon: "warehouse", items: [
    ...
    { key: "correspondence", label: "Radicación", icon: "mail", perms: ["mail.view","mail.manage"] },
  ]},
